...
tod = pygame.mixer.Sound('springen.mp3')
tod.set_volume(.7)
levelup = pygame.mixer.Sound('springen.mp3')
levelup.set_volume(.7)
gameover = pygame.mixer.Sound('springen.mp3')
