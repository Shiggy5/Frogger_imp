def frogger(fensterhoehe):
    ...
    level = 1
    #Levelmultiplikator (Erhöhung der Geschwindigkeit
    ...
    sprung = pygame.transform.scale(frog1, (ballbreite, ballhoehe + (ballhoehe * (1/2))))
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_RIGHT and Froschda == True and pause == False:
                    if not ballpos_x + ballbreite >= FENSTERBREITE - (ballhoehe -1):
                        ...
                        #screen.blit(frogl[framef], (ballpos_x, ballpos_y))
