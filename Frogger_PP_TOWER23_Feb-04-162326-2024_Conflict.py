def frogger(fensterhoehe):
    ...
    krokopos = [zielpos_1, zielpos_2, zielpos_3, zielpos_4, zielpos_5, -100, -140, -130]
    ...
    #           elif event.type == pygame.MOUSEBUTTONDOWN:
        ...
        if Ziel1 == True and Ziel2 == True and Ziel3 == True and Ziel4 == True and Ziel5 == True:
            ...
            anzahlkroko = 5
            krokopos = [zielpos_1, zielpos_2, zielpos_3, zielpos_4, zielpos_5, -150, -140, -130, -120]
        ...
        if level >= 2:
            if pause == False:
                if framekroko % 750 == 0 or not krokopos_x in krokopos:
                    krokopos_x = random.choice(krokopos)
            ...
            if framekroko % 100 == 0:
                ...
                if framek > 1:
                    framek = 0
            screen.blit(krokol[framek], (krokopos_x, zielpos_y))
    ...
    #    pygame.display.flip()
        ...
        if godmode == False:
            ...
            if ballpos_y < FENSTERHOEHE * (1/8):
                if ballpos_x == krokopos_x:
                    leben -= 1
                    ballpos_x = spawnx
                    ballpos_y = spawny
